...
const ApiAccess = () => {
    ...
    const handleCreateKey = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                showError('API Key created successfully', { type: 'success', title: 'Success' });
            } else {
                showError('Failed to create API key', { type: 'error', title: 'Error' });
            }
        } catch (error) {
    ...
    const confirmDeleteKey = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                showError('API Key revoked successfully', { type: 'success', title: 'Revoked' });
            } else {
                showError('Failed to revoke API key', { type: 'error', title: 'Error' });
            }
        } catch (error) {
    ...
    const copyToClipboard = (text) => {
        ...
        showError('API Key copied to clipboard', { type: 'info', title: 'Copied' });
    };
