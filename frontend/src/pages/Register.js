        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#f0f9ff] via-[#e0f2fe] to-[#eff6ff] p-12 flex-col justify-between">
          ...
          <div className="flex items-center justify-center flex-1">
            <div className="max-w-md">
              <h1 className="text-[28px] leading-[34px] font-semibold text-gray-900 mb-7 font-walsheim-semibold">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start space-x-2.5">
                  ...
                  <div>
                    <p className="text-[15px] leading-[22px] text-gray-900 font-medium mb-0.5 font-walsheim-semibold">Ready-to-use web scrapers</p>
                ...
                <div className="flex items-start space-x-2.5">
                  ...
                  <div>
                    <p className="text-[15px] leading-[22px] text-gray-900 font-medium mb-0.5 font-walsheim-semibold">Run your own code</p>
                    <p className="text-[13px] leading-[19px] text-gray-600">
                ...
                <div className="flex items-start space-x-2.5">
                  ...
                  <div>
                    <p className="text-[15px] leading-[22px] text-gray-900 font-medium mb-0.5 font-walsheim-semibold">Never get blocked</p>
                    <p className="text-[13px] leading-[19px] text-gray-600">
