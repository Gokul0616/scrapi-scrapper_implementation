            ...
            <div className="p-4 border-b border-gray-200 bg-white">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <button
                  ...
                  disabled={!previewUrl || proxyPreviewLoading}
              ...
              {cookies.length > 0 && (
                <div className="flex items-center space-x-2 text-xs text-green-700 bg-green-50 px-2 py-1 rounded">
                  ...
                  <span>{cookies.length} cookie(s) configured</span>
                </div>
              )}
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-blue-900">
                        Using Backend Preview
                      </p>
                      <p className="text-sm text-blue-700 mt-1">
                        This site blocks iframe embedding. We're loading it through our backend proxy instead.
                      </p>
                    </div>
                  </div>
                </div>
