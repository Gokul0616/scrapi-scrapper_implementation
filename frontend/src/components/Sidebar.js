  ...
  return (
    <TooltipProvider delayDuration={500} skipDelayDuration={0}>
      <div className="relative h-screen">
        ...
        {/* Search Modal - Clean Notion Design */}
        {isSearchModalOpen && (
          <div
            className="fixed inset-0 bg-black/50 flex items-start justify-center pt-[12vh] z-50 px-4"
          ...
          >
            ...
            >
              ...
              <div className={`flex items-center gap-3 px-5 py-4 ${
                ...
                />
                <kbd className={`px-2 py-1 text-[11px] font-medium rounded ${
                  theme === 'dark'
              ...
              {/* Divider */}
              <div className={`h-[1px] ${theme === 'dark' ? 'bg-[#2a2a2a]' : 'bg-gray-100'}`} />

              {/* Search Results - No Scrollbar */}
              <div 
                className={`max-h-[460px] overflow-y-auto hide-scrollbar ${
                  theme === 'dark' ? 'bg-[#191919]' : 'bg-white'
                }`}
              >
                {/* Navigation */}
                <div className="py-2">
                  <div className={`px-5 py-2 text-[11px] font-semibold ${
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1">
                        {item.shortcut.split(' ').map((key, idx) => (
                          <kbd
                            key={idx}
                            className={`px-1.5 py-0.5 text-[10px] font-medium rounded min-w-[18px] text-center ${
                              theme === 'dark'
                                ? 'bg-[#2a2a2a] text-gray-500'
                                : 'bg-gray-100 text-gray-500'
                            }`}
                ...
                {/* Divider */}
                <div className={`h-[1px] mx-5 ${theme === 'dark' ? 'bg-[#2a2a2a]' : 'bg-gray-100'}`} />
