...
const FeatureCard = ({ icon, title, description, linkText, linkHref }) => (
  <a
    href={linkHref || '#'}
    className="flex flex-col p-6 bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-xl hover:shadow-md dark:hover:bg-zinc-900 dark:hover:border-gray-700 transition-all group"
  >
    <div className="mb-4">
