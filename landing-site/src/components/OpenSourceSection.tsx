...
import { Copy, Check, Github, Terminal, AlertCircle, Download, Database } from 'lucide-react';
...
const MonitoringVisual: React.FC = () => (
...
// Deployment Icons
const DeploymentIcons: React.FC = () => (
...
const OpenSourceSection: React.FC<OpenSourceSectionProps> = ({ templates }) => {
    ...
    const getContent = () => {
        switch (activeTab) {
            ...
            default:
                return { title: '', description: '', showCode: false, visual: undefined, codeType: undefined };
        }
    };
