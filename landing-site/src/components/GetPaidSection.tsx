        ...
        <section className="py-16 px-6 bg-white dark:bg-black">
            <div className="max-w-[1400px] mx-auto">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    {/* Left Content */}
                    <div>
                        <h2 className="text-3xl md:text-4xl font-semibold text-gray-900 dark:text-white mb-2">
                            Built for scale and reliability
                        </h2>
                        <h3 className="text-2xl font-semibold text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    {/* Right - Illustration */}
                    <div className="bg-gradient-to-br from-[#2BC56B]/10 to-gray-50 dark:to-gray-900 rounded-xl p-8">
                        <div className="aspect-square max-w-md mx-auto flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600 dark:text-gray-400">Extract data at scale with confidence</p>
                            </div>
                        </div>
                    </div>
                </div>
