...
BACKEND_URL = "https://high-perf-scraping.preview.emergentagent.com/api"
...
class ScrapiAPITester:
    ...
    def test_indeed_jobs_scraper_zero_results_fix(self):
        ...
        # Add indeed_zero_results to test results if not exists
        if "indeed_zero_results" not in self.test_results:
            self.test_results["indeed_zero_results"] = {"passed": 0, "failed": 0, "errors": []}
